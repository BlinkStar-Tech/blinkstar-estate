    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Grid container spacing={2} sx={{ mb: 4 }}>
        {property.images && property.images.map((img, idx) => (
          <Grid item xs={12} sm={idx === 0 ? 12 : 6} md={idx === 0 ? 12 : 4} key={idx}>
            <Card 
              sx={{ 
                borderRadius: 2, 
                overflow: 'hidden', 
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} md={8}>
          <Paper elevation={0} sx={{ p: 3, mb: 3, borderRadius: 2, border: '1px solid #e0e0e0' }}>
            <Typography variant="h5" sx={{ mb: 2, fontWeight: 600 }}>Property Details</Typography>
            <Divider sx={{ mb: 3 }} />
            ...
            <Grid container spacing={2} sx={{ mt: 2 }}>
              ...
              <Grid item xs={6} sm={3}>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Typography>{property.area.toLocaleString()} sq ft</Typography>
                </Box>
              </Grid>
            </Grid>
          </Paper>
          ...
          {isOwner && (
            <Paper elevation={0} sx={{ p: 3, mb: 3, borderRadius: 2, border: '1px solid #e0e0e0' }}>
              <Typography variant="h6" sx={{ mb: 2 }}>Manage Your Property</Typography>
              <Box>
                <Button 
                  variant="contained" 
                  startIcon={<Edit />}
        ...
        <Grid item xs={12} md={4}>
          <Paper elevation={3} sx={{ p: 3, borderRadius: 2, position: 'sticky', top: 20 }}>
            <Typography variant="h6" sx={{ mb: 2, fontWeight: 600 }}>Contact About This Property</Typography>
            <ContactForm 
